...
- **Việc còn lại (ưu tiên phiên sau):** ✅ ~~exam edit/release CRUD~~ (A7 `9cea81f`) · ✅ ~~exam lifecycle UI~~ (A8 `82a244f`) · ✅ ~~MATRIX-002 toàn-đề~~ (B7 `5918e3d`, gap→active) · 🏁 **Generator EN SPEC-COMPLETE**. Còn lại đều ĐÃ HOÃN: **VSTEP/HSK** đa ngôn ngữ + **phân hệ Chấm** (GRADE-002 gap, GRADE-003/SCALE-003 planned, Celery).
