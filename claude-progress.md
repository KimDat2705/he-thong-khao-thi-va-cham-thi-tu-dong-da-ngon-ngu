...
- **Việc còn lại (ưu tiên phiên sau):** **MATRIX-002 toàn-đề** (xfail — khó: P7 nghiệm-duy-nhất khoá độ khó, mổ conftest giòn) · **exam edit/release CRUD** (để exam-admin-api → active) · (hoãn) **VSTEP/HSK** đa ngôn ngữ + **phân hệ Chấm** (GRADE-002/003, Celery).
